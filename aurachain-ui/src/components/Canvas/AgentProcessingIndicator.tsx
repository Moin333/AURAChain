  ...
  return (
    <div className={clsx("flex items-center gap-3", className)}>
      ...
      <div className="relative flex-shrink-0">
        {/* Subtle Glow */}
        <div className="absolute inset-0 -m-1 bg-primary-400/20 dark:bg-primary-500/20 rounded-full blur-md animate-pulse-slow" />
      ...
      <div className="flex-1 min-w-0">
        <div className="text-xs font-semibold text-slate-700 dark:text-zinc-100 truncate mb-1">
          {agentName}
        </div>
        ...
        {progress > 0 && (
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-mono text-slate-500 dark:text-zinc-500 w-8 text-right">
              {progress}%
            </span>
          </div>
        )}
